...
import {  arrowBack, search, notifications, camera, bag, cubeOutline, cartOutline, barChartOutline, createOutline, trashOutline, trendingUp, trendingDown, logoUsd, alertCircleOutline, informationCircle, barcodeOutline, documentTextOutline, pricetagOutline, alertCircle, businessOutline, resizeOutline, layersOutline, warningOutline, cashOutline, cardOutline, saveOutline, closeOutline, pricetag, ribbon, layers, cube, alert, cash, downloadOutline, funnel, checkmarkSharp, closeCircle, save, close, imageOutline, image } from 'ionicons/icons';
